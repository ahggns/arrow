...
set(command "/usr/local/Cellar/cmake/3.22.1/bin/cmake;--build;.")
set(log_merged "")
set(log_output_on_failure "1")
set(stdout_log "/Users/ahiggins/src/apache/arrow/cpp/src/xsimd_ep-stamp/xsimd_ep-build-out.log")
set(stderr_log "/Users/ahiggins/src/apache/arrow/cpp/src/xsimd_ep-stamp/xsimd_ep-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/ahiggins/src/apache/arrow/cpp/src/xsimd_ep-stamp/xsimd_ep-build-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "xsimd_ep build command succeeded.  See also /Users/ahiggins/src/apache/arrow/cpp/src/xsimd_ep-stamp/xsimd_ep-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
